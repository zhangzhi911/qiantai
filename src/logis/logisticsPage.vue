<template>
  <div>
    ...
    <div
      style="width: 1000px;margin-left: 200px;margin-top: 35px;background-color:yellow;min-height:1000px;"
    >
      <addorder></addorder>
    </div>
    <div style="width: 1000px;margin-left: 200px;margin-top: 35px">
      <Mycommont></Mycommont>
    </div>
    <!-- 脚 -->
    <el-row>
...
import Mycommont from "@/components/firstPage/Commont";
import addorder from "@/logis/addorder";
