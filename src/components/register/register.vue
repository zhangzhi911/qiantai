    ...
    <div class="ms-register">
      ...
      <el-form :model="ruleForm" :rules="rules" ref="ruleForm" label-width="0px" class="ms-content">
        ...
        <el-form-item prop="permiss">
          <el-input placeholder="请输入邮箱" style="width:60%;" v-model="ruleForm.permiss"></el-input>
...
export default {
  ...
  data() {
    ...
    var validatePermiss = (rule, value, callback) => {
      ...
      } else if (value != this.retureValidate) {
    ...
    var qqMail = (rule, value, callback) => {
      ...
      } else if (shortName != "@qq.com") {
        callback(new Error("邮箱暂时支持qq邮箱!"));
      } else {
        this.sendShow = false;
        callback();
      }
  ...
  methods: {
    ...
    countDown() {
      axios({
        url: "userpost/validation",
        method: "post",
        data: Qs.stringify({ permiss: this.ruleForm.permiss })
      }).then(e => {
